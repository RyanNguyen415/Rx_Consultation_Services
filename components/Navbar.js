...
import logo from '../public/static/rn_rx.png'
function Navbar() {
        ...
        <div>
          ...
          <ul className={styles.ul}>
            <li>
              ...
              <a href="mailto:ryanlongnguyen415@gmail.com">email us</a>
            </li>
            <li>
          ...
          <ul>
            <li tabIndex="1">
              ...
              <ul className={styles.subMenu}>
                <li>
                  <Link href={"/treatments/3"}>
                    <a>Erectile Dysfunction</a>
                  </Link>
                </li>
                <li>
                  <Link href={"/treatments/5"}>
                    <a>Hair Loss</a>
                  </Link>
                </li>
              </ul>
            ...
            <li tabIndex="2">
              ...
              <ul className={styles.subMenu}>
                <li>
                  <Link href={"/treatments/7"}>
                    <a>Period Delay</a>
                  </Link>
                </li>
                <li>
                  <Link href={"/treatments/2"}>
                    <a>Weight Loss</a>
                  </Link>
                </li>
                <li>
                  <Link href={"/treatments/9"}>
                    <a>Acne</a>
                  </Link>
                </li>
                <li>
                  <Link href={"/treatments/6"}>
                    <a>Migraine</a>
                  </Link>
                </li>
              </ul>
            ...
            <li tabIndex="3">
              ...
              <ul className={styles.subMenu}>
                <li>
                  <Link href={"/treatments/1"}>
                    <a>Acid Reflux</a>
                  </Link>
                </li>
                <li>
                  <Link href={"/treatments/4"}>
                    <a>Asthma</a>
                  </Link>
                </li>
              </ul>
          ...
          <ul id={styles.mobileNavigations}>
            <li tabIndex={"1"}>
              ...
              <ul className={styles.submenu}>
                ...
                <li onClick={hideMobileNav}>
                  <Link href={"/treatments/8"}>
                    <a>Premature Ejaculation</a>
                  </Link>
                </li>
              </ul>
            </li>
